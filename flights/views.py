...
from .permissions import OwnerAccessPermission, ModificationPermission
...
class BookingDetails(RetrieveAPIView):
	...
	permission_classes = [OwnerAccessPermission,]
...
class UpdateBooking(RetrieveUpdateAPIView):
	...
	lookup_field = 'id'
	lookup_url_kwarg = 'booking_id'
	permission_classes = [OwnerAccessPermission, ModificationPermission]
